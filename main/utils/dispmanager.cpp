...
void dispmanager::init_screen() {
    ...
    io_config = SH8601_PANEL_IO_QSPI_CONFIG(EXAMPLE_PIN_NUM_LCD_CS, example_notify_lvgl_flush_ready, NULL);
...
void dispmanager::init_lvgl() {
    ...
    disp_cfg.io_handle = screen_spi_handle;
    disp_cfg.panel_handle = screen_handle;
    disp_cfg.buffer_size = EXAMPLE_LCD_H_RES * EXAMPLE_LCD_V_RES / 4;
    ...
    static lv_disp_t *disp_handle = lvgl_port_add_disp(&disp_cfg);
